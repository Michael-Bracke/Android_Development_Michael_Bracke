...
class RegisterSSA() : AppCompatActivity() {
    ...
    private fun Registeren() {
        ...
        val regPasswrd2 = findViewById<TextView>(R.id.inptPassword2)
        ...
        } else if (regPasswrd != regPasswrd2) {
            regPasswrd.setError("Wachtwoorden komen niet overeen!")
            regPasswrd2.setError("Wachtwoorden komen niet overeen!")
        } else {
